...
object Administrators {
    ...
    init {
        administrators.add(Administrator(1, "Admin1","Admin1", "admin1@gmail.com","1234",1,1,1,21, "123"))
        administrators.add(Administrator(2, "Admin2","Admin2", "admin2@gmail.com","4321",1,1,1,20, "321"))
    }
